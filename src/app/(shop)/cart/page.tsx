          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <div className="mt-2 flex flex-wrap justify-center gap-2">
                <Link href="/products?category=electronics" className="text-primary hover:underline">
                  Eletrônicos
                </Link>
                <span>•</span>
                <Link href="/products?category=computers" className="text-primary hover:underline">
                  Computadores
                </Link>
                <span>•</span>
                <Link href="/products?category=audio" className="text-primary hover:underline">
                  Áudio
                </Link>
              </div>
            </div>
