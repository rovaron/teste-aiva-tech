...
interface UIActions {
  ...
  updateFilter: (key: keyof ProductFilters, value: string | number | boolean | string[]) => void
  clearFilters: () => void
  ...
  devtools(
    persist(
      (set): UIStore => ({
        ...
        toggleCart: () => set((state: UIState) => ({ cartOpen: !state.cartOpen })),
        ...
        updateFilter: (key: keyof ProductFilters, value: string | number | boolean | string[]) => 
          set((state: UIState) => ({ 
        ...
        setProductsLoading: (productsLoading: boolean) => 
          set({ productsLoading }),
        setCartLoading: (cartLoading: boolean) => 
          set({ cartLoading }),
...
export const useProductsLoading = () => useUIStore((state) => state.productsLoading)
...
export const useAuthModalActions = () => useUIStore((state) => ({
  openAuthModal: state.openAuthModal,
  closeAuthModal: state.closeAuthModal,
  setAuthModalMode: state.setAuthModalMode,
}))

export const useViewActions = () => useUIStore((state) => ({
